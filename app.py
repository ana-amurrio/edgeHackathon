...
with st.sidebar:
    ...
    st.markdown("- I've completed ENGL 1A. What's next?")
    st.markdown("- What do I need before BUS3 189?")
    st.markdown("- What is the full prereq chain for BUS4 119A?")
    st.markdown("- I have BUS1 20 and BUS2 90. Am I blocked from BUS1 170?")